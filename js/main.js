...
const app = new Vue({
    ...
    methods: {
        ...
        하이브리드실제종합전투력계산(치피감, 뎀감, 타입피증){
            return (this.물리실제종합전투력계산(치피감, 뎀감, 타입피증) + this.마법실제종합전투력계산(치피감, 뎀감, 타입피증)) / 2;
        },
        ...
        조건부물리데미지계산(){
            ...
            const 정면 = 공통 * (1 + (물치피 - 치피감 > 0 ? 물치피 - 치피감 : 0) / 100) * (1 + 타입피증 / 100);

            const 에 = 공통 * (1 + (물치피 + 에치피 - 치피감 > 0 ? 물치피 + 에치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 에피증) / 100);
            const 백 = 공통 * (1 + (물치피 + 백치피 - 치피감 > 0 ? 물치피 + 백치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 백피증) / 100);
            const 체 = 공통 * (1 + (물치피 + 체치피 - 치피감 > 0 ? 물치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 체피증) / 100);

            const 에백 = 공통 * (1 + (물치피 + 에치피 + 백치피 - 치피감 > 0 ? 물치피 + 에치피 + 백치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 에피증 + 백피증) / 100);
            const 에체 = 공통 * (1 + (물치피 + 에치피 + 체치피 - 치피감 > 0 ? 물치피 + 에치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 에피증 + 체피증) / 100);
            const 백체 = 공통 * (1 + (물치피 + 백치피 + 체치피 - 치피감 > 0 ? 물치피 + 백치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 백피증 + 체피증) / 100);

            const 에백체 = 공통 * (1 + (물치피 + 에치피 + 백치피 + 체치피 - 치피감 > 0 ? 물치피 + 에치피 + 백치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 에피증 + 백피증 + 체피증) / 100);


            const 위 = 공통 * (1 + (물치피 - 치피감 > 0 ? 물치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀) / 100);

            const 위에 = 공통 * (1 + (물치피 + 에치피 - 치피감 > 0 ? 물치피 + 에치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 에피증) / 100);
            const 위백 = 공통 * (1 + (물치피 + 백치피 - 치피감 > 0 ? 물치피 + 백치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 백피증) / 100);
            const 위체 = 공통 * (1 + (물치피 + 체치피 - 치피감 > 0 ? 물치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 체피증) / 100);

            const 위에백 = 공통 * (1 + (물치피 + 에치피 + 백치피 - 치피감 > 0 ? 물치피 + 에치피 + 백치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 에피증 + 백피증) / 100);
            const 위에체 = 공통 * (1 + (물치피 + 에치피 + 체치피 - 치피감 > 0 ? 물치피 + 에치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 에피증 + 체피증) / 100);
            const 위백체 = 공통 * (1 + (물치피 + 백치피 + 체치피 - 치피감 > 0 ? 물치피 + 백치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 백피증 + 체피증) / 100);

            const 위에백체 = 공통 * (1 + (물치피 + 에치피 + 백치피 + 체치피 - 치피감 > 0 ? 물치피 + 에치피 + 백치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 에피증 + 백피증 + 체피증) / 100);
        ...
        조건부마법데미지계산(){
            ...
            const 정면 = 공통 * (1 + (마치피 - 치피감 > 0 ? 마치피 - 치피감 : 0) / 100) * (1 + 타입피증 / 100);

            const 에 = 공통 * (1 + (마치피 + 에치피 - 치피감 > 0 ? 마치피 + 에치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 에피증) / 100);
            const 백 = 공통 * (1 + (마치피 + 백치피 - 치피감 > 0 ? 마치피 + 백치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 백피증) / 100);
            const 체 = 공통 * (1 + (마치피 + 체치피 - 치피감 > 0 ? 마치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 체피증) / 100);

            const 에백 = 공통 * (1 + (마치피 + 에치피 + 백치피 - 치피감 > 0 ? 마치피 + 에치피 + 백치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 에피증 + 백피증) / 100);
            const 에체 = 공통 * (1 + (마치피 + 에치피 + 체치피 - 치피감 > 0 ? 마치피 + 에치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 에피증 + 체피증) / 100);
            const 백체 = 공통 * (1 + (마치피 + 백치피 + 체치피 - 치피감 > 0 ? 마치피 + 백치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 백피증 + 체피증) / 100);

            const 에백체 = 공통 * (1 + (마치피 + 에치피 + 백치피 + 체치피 - 치피감 > 0 ? 마치피 + 에치피 + 백치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 에피증 + 백피증 + 체피증) / 100);


            const 위 = 공통 * (1 + (마치피 - 치피감 > 0 ? 마치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀) / 100);

            const 위에 = 공통 * (1 + (마치피 + 에치피 - 치피감 > 0 ? 마치피 + 에치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 에피증) / 100);
            const 위백 = 공통 * (1 + (마치피 + 백치피 - 치피감 > 0 ? 마치피 + 백치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 백피증) / 100);
            const 위체 = 공통 * (1 + (마치피 + 체치피 - 치피감 > 0 ? 마치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 체피증) / 100);

            const 위에백 = 공통 * (1 + (마치피 + 에치피 + 백치피 - 치피감 > 0 ? 마치피 + 에치피 + 백치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 에피증 + 백피증) / 100);
            const 위에체 = 공통 * (1 + (마치피 + 에치피 + 체치피 - 치피감 > 0 ? 마치피 + 에치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 에피증 + 체피증) / 100);
            const 위백체 = 공통 * (1 + (마치피 + 백치피 + 체치피 - 치피감 > 0 ? 마치피 + 백치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 백피증 + 체피증) / 100);

            const 위에백체 = 공통 * (1 + (마치피 + 에치피 + 백치피 + 체치피 - 치피감 > 0 ? 마치피 + 에치피 + 백치피 + 체치피 - 치피감 : 0) / 100) * (1 + (타입피증 + 위개뎀 + 에피증 + 백피증 + 체피증) / 100);
